    ...
    <ToastContext.Provider value={{ addToast, removeToast, success, error, info, warning }}>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2 max-w-md w-full pointer-events-none px-4">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`pointer-events-auto flex items-start gap-3 p-4 rounded-xl border shadow-xl backdrop-blur-xl animate-slide-up transition-all ${
              toast.type === 'success'
                ...
                : 'bg-slate-900/90 border-brand-500/40 text-brand-100 shadow-indigo-950/50'
            }`}
          >
